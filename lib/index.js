...
internals.schema = Joi.object({
    provider: Joi.object({
        ...
        headers: Joi.object(),
        profile: Joi.func(),
        resource: Joi.string().when('name', { is: 'microsoftonline', then: Joi.required(), otherwise: Joi.forbidden() }),
        response_type: Joi.string().optional().default('code'),
        response_mode: Joi.string().optional().default('query'),
        nonce: Joi.boolean().optional().default(false),
