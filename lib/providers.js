...
exports = module.exports = {
    ...
    twitter: {
        ...
        profile: function (credentials, params, client, callback) {
            ...
            client.get('https://api.twitter.com/1.1/users/show.json', { user_id: params.user_id }, credentials.token, credentials.secret, function (err, payload) {
    ...
    yahoo: {
        ...
        profile: function (credentials, params, client, callback) {
            ...
            client.get('https://social.yahooapis.com/v1/user/' + params.xoauth_yahoo_guid + '/profile', { format: 'json' }, credentials.token, credentials.secret, function (err, payload) {
