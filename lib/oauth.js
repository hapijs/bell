...
internals.Client.prototype.get = function (uri, params, oauth_token, tokenSecret, callback) {
    ...
    oauth.oauth_signature = this.signature('GET', this.settings.token, params, oauth, tokenSecret);
...
internals.Client.prototype.baseUri = function (uri) {
    ...
    var baseUri = protocol + '//' + resource.hostname.toLowerCase() + (isDefaultPort ? '' : ':' + resource.port) + resource.pathname;
    return baseUri;
};
