...
exports.v2 = function (settings) {
    ...
    return function (request, reply) {
        ...
        if (!settings.provider.useParamsAuth) {
            requestOptions.headers.Authorization = 'Basic ' + (new Buffer(settings.clientId + ':' + ((typeof settings.clientSecret === 'string') ? settings.clientSecret : ''), 'utf8')).toString('base64');
        }
